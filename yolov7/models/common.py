...
class CoordAtt(nn.Module): # ch_in, ch_out, kernel, stride, padding, groups
...
class eGAM_Attention(nn.Module):
   #https://paperswithcode.com/paper/global-attention-mechanism-retain-information
    def __init__(self, c1, c2, group=True,rate=4):
        ...
        self.spatial_attention = nn.Sequential(
            ...
            nn.Conv2d(c1, c1//rate, kernl_size=7, padding=3,groups=rate)if group else nn.Conv2d(c1, int(c1 / rate), kernel_size=7, padding=3),
